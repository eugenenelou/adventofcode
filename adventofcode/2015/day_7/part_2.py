...
def main(input):
    ...
    a_value = compute_a(instructions)

    instructions = [inst for inst in instructions if not inst.endswith("-> b")]
    instructions.append(f"{a_value} -> b")

    return compute_a(instructions)
